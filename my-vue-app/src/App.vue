...
<style>
/* Global styles (or move to a separate main.css file) */
body {
  margin: 0;
  font-family: 'Arial Narrow Bold', sans-serif; /* Use a common sans-serif font */
...
.main-content {
 /*padding: 20px;
  /*max-width: 900px; /* Max width similar to the image */
